...
| Port/Rebuild | useful idea, but should be manually re-landed inside the local harness |
...
- External-source features should be rebuilt inside the local harness when they are valuable but not self-contained
...
- "Map GitHub issues into our harness program lanes"
