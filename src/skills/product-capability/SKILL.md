...
description: Translate PRD intent, roadmap asks, or product discussions into an implementation-ready capability plan that exposes constraints, invariants, interfaces, and unresolved decisions before multi-service work starts. Use when the user needs a Codex-native PRD-to-SRS lane instead of vague planning prose.
...
If useful, point to the next Codex-native lane:
...
HANDOFF
- what should happen next and which Codex lane should take it
```
...
- The resulting plan is reusable by Codex and can be adapted to other agent harnesses if needed.
